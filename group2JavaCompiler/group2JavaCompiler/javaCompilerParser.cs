...
// DateTime: 15-Apr-16 1:42:12 PM
// UserName: Praveen
// Input file <javaCompilerParser.y - 15-Apr-16 1:38:44 PM>
...
public enum Tokens {error=2,EOF=3,IDENTIFIER=4,INTEGER_LITERAL=5,BOOL_LITERAL=6,
    ...
    OP_DOT=31,SYSTEM=32,OUT=33,PRINTLN=34,OP_ASSIGN=35,OP_ADD=36,
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "Expression", "LambdaExpression", "LambdaParameters", "LocalVariableDeclaration", 
  ...
  static Parser() {
    states[0] = new State(new int[]{7,112,8,113,9,114,10,115,11,116,12,117,15,118,19,119,23,125},new int[]{-1,1,-3,3,-8,4,-9,5,-10,6,-12,110,-4,122,-5,124});
    ...
    states[10] = new State(new int[]{7,99,8,100,9,101,10,102,11,103,12,104,13,105,14,106,15,107,16,96},new int[]{-13,11,-14,13,-15,14,-16,15,-19,97,-17,108,-20,85});
    states[11] = new State(new int[]{29,12});
    states[12] = new State(-23);
    states[13] = new State(-24);
    states[14] = new State(-25);
    states[15] = new State(new int[]{16,96},new int[]{-17,16,-20,85});
    states[16] = new State(new int[]{28,19},new int[]{-18,17,-32,18});
    states[17] = new State(-26);
    states[18] = new State(-52);
    states[19] = new State(new int[]{4,64,21,68,32,80},new int[]{-33,20,-34,22,-35,23,-46,24,-25,26,-27,58,-29,59,-30,60,-28,65,-48,66,-49,67,-36,69,-37,70,-38,71,-39,72,-40,74,-41,75});
    ...
    states[25] = new State(-67);
    states[26] = new State(new int[]{4,57},new int[]{-47,27,-50,28,-26,29});
    states[27] = new State(-68);
    states[28] = new State(-72);
    states[29] = new State(new int[]{44,30});
    states[30] = new State(new int[]{50,35,5,56},new int[]{-51,31,-43,32,-44,33,-45,34,-52,38,-53,39,-54,40,-55,41,-56,42,-57,43,-58,44,-59,45,-60,46,-61,47,-62,48,-63,49,-64,50,-65,51,-66,52,-67,53,-68,54,-69,55});
    states[31] = new State(-73);
    states[32] = new State(-75);
    states[33] = new State(-64);
    states[34] = new State(-65);
    states[35] = new State(new int[]{4,36});
    states[36] = new State(new int[]{50,37});
    ...
    states[60] = new State(new int[]{26,62},new int[]{-31,61});
    ...
    states[66] = new State(-69);
    states[67] = new State(-70);
    states[68] = new State(-71);
    states[69] = new State(-56);
    states[70] = new State(-57);
    states[71] = new State(-58);
    states[72] = new State(new int[]{30,73});
    states[73] = new State(-59);
    states[74] = new State(-60);
    states[75] = new State(new int[]{24,76});
    states[76] = new State(new int[]{50,35,5,56},new int[]{-42,77,-43,79,-44,33,-45,34,-52,38,-53,39,-54,40,-55,41,-56,42,-57,43,-58,44,-59,45,-60,46,-61,47,-62,48,-63,49,-64,50,-65,51,-66,52,-67,53,-68,54,-69,55});
    states[77] = new State(new int[]{25,78});
    states[78] = new State(-61);
    states[79] = new State(-63);
    states[80] = new State(new int[]{31,81});
    states[81] = new State(new int[]{33,82});
    states[82] = new State(new int[]{31,83});
    states[83] = new State(new int[]{34,84});
    states[84] = new State(-62);
    states[85] = new State(new int[]{4,87},new int[]{-21,86});
    states[86] = new State(-39);
    states[87] = new State(new int[]{24,88});
    states[88] = new State(new int[]{25,91,4,64,21,68},new int[]{-22,89,-23,92,-24,93,-25,94,-27,58,-29,59,-30,60,-28,65,-48,66,-49,67});
    ...
    states[94] = new State(new int[]{4,57},new int[]{-26,95});
    states[95] = new State(-45);
    states[96] = new State(-40);
    states[97] = new State(new int[]{7,99,8,100,9,101,10,102,11,103,12,104,13,105,14,106,15,107,16,-29},new int[]{-16,98,-19,97});
    ...
    states[108] = new State(new int[]{28,19},new int[]{-18,109,-32,18});
    states[109] = new State(-27);
    states[110] = new State(new int[]{7,112,8,113,9,114,10,115,11,116,12,117,15,118,19,-15},new int[]{-10,111,-12,110});
    ...
    states[120] = new State(new int[]{28,10},new int[]{-11,121});
    states[121] = new State(-13);
    states[122] = new State(new int[]{7,112,8,113,9,114,10,115,11,116,12,117,15,118,19,119,3,-3},new int[]{-3,123,-8,4,-9,5,-10,6,-12,110});
    states[123] = new State(-4);
    states[124] = new State(-5);
    states[125] = new State(new int[]{4,130},new int[]{-6,126,-7,127});
    states[126] = new State(-6);
    states[127] = new State(new int[]{31,128});
    states[128] = new State(new int[]{4,129});
    states[129] = new State(new int[]{7,-7,8,-7,9,-7,10,-7,11,-7,12,-7,15,-7,19,-7,3,-7,31,-8});
    ...
    rules[59] = new Rule(-38, new int[]{-39,30});
    rules[60] = new Rule(-39, new int[]{-40});
    rules[61] = new Rule(-40, new int[]{-41,24,-42,25});
    rules[62] = new Rule(-41, new int[]{32,31,33,31,34});
    rules[63] = new Rule(-42, new int[]{-43});
    rules[64] = new Rule(-43, new int[]{-44});
    rules[65] = new Rule(-44, new int[]{-45});
    rules[66] = new Rule(-45, new int[]{50,4,50});
    rules[67] = new Rule(-35, new int[]{-46,30});
    rules[68] = new Rule(-46, new int[]{-25,-47});
    rules[69] = new Rule(-28, new int[]{-48});
    rules[70] = new Rule(-48, new int[]{-49});
    rules[71] = new Rule(-49, new int[]{21});
    rules[72] = new Rule(-47, new int[]{-50});
    rules[73] = new Rule(-50, new int[]{-26,44,-51});
    rules[74] = new Rule(-26, new int[]{4});
    rules[75] = new Rule(-51, new int[]{-43});
    rules[76] = new Rule(-43, new int[]{-52});
    rules[77] = new Rule(-52, new int[]{-53});
    rules[78] = new Rule(-53, new int[]{-54});
    rules[79] = new Rule(-54, new int[]{-55});
    rules[80] = new Rule(-55, new int[]{-56});
    rules[81] = new Rule(-56, new int[]{-57});
    rules[82] = new Rule(-57, new int[]{-58});
    rules[83] = new Rule(-58, new int[]{-59});
    rules[84] = new Rule(-59, new int[]{-60});
    rules[85] = new Rule(-60, new int[]{-61});
    rules[86] = new Rule(-61, new int[]{-62});
    rules[87] = new Rule(-62, new int[]{-63});
    rules[88] = new Rule(-63, new int[]{-64});
    rules[89] = new Rule(-64, new int[]{-65});
    rules[90] = new Rule(-65, new int[]{-66});
    rules[91] = new Rule(-66, new int[]{-67});
    rules[92] = new Rule(-67, new int[]{-68});
    rules[93] = new Rule(-68, new int[]{-69});
    rules[94] = new Rule(-69, new int[]{5});
  }

...
// GPPG version 1.5.2
// Machine:  PRETTYPC
// DateTime: 5/29/2016 2:58:02 PM
// UserName: Pretty
// Input file <javaCompilerParser.y - 5/29/2016 2:57:58 PM>
...
{
  // Verbatim content from javaCompilerParser.y - 5/29/2016 2:57:58 PM
#line 5 "javaCompilerParser.y"
public static AST.Class root;
#line default
  // End verbatim content from javaCompilerParser.y - 5/29/2016 2:57:58 PM
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      "VariableDeclarator", "VariableDeclaratorId", "VariableDeclaratorList", 
      ...
      "UnannPrimitiveType", "ClassMemberDeclaration", "Expression", "Statement", 
      ...
      "UnannReferenceType", "VariableInitializer", "AssignmentExpression", "ConditionalExpression", 
      "ExpressionName", "ConditionalOrExpression", "ConditionalAndExpression", 
      "InclusiveOrExpression", "ExclusiveOrExpression", "AndExpression", "EqualityExpression", 
      "RelationalExpression", "ShiftExpression", "AdditiveExpression", "MultiplicativeExpression", 
      "UnaryExpression", "UnaryExpressionNotPlusMinus", "PostfixExpression", 
      "Primary", "PrimaryNoNewArray", "Literal", "StatementWithoutTrailingSubstatement", 
  ...
  static Parser() {
    states[0] = new State(new int[]{7,133,8,134,9,135,10,136,11,137,12,138,15,139,23,143,19,-85},new int[]{-22,1,-58,3,-23,4,-21,5,-25,6,-63,131,-59,140,-60,142});
    ...
    states[9] = new State(new int[]{7,118,8,119,9,120,10,121,11,122,12,123,13,115,14,116,15,117,4,105,21,68,16,-8},new int[]{-13,10,-20,12,-27,13,-28,107,-26,124,-8,125,-29,58,-66,59,-67,60,-12,65,-11,66,-10,67,-65,127,-64,130});
    states[10] = new State(new int[]{29,11});
    states[11] = new State(-3);
    states[12] = new State(-4);
    states[13] = new State(new int[]{16,106},new int[]{-9,14});
    states[14] = new State(new int[]{4,15});
    states[15] = new State(new int[]{24,16});
    states[16] = new State(new int[]{4,105,21,68,25,-11},new int[]{-5,17,-6,101,-7,102,-8,103,-29,58,-66,59,-67,60,-12,65,-11,66,-10,67});
    states[17] = new State(new int[]{25,18});
    states[18] = new State(new int[]{28,21},new int[]{-17,19,-18,20});
    states[19] = new State(-6);
    states[20] = new State(-19);
    states[21] = new State(-22,new int[]{-19,22});
    states[22] = new State(new int[]{29,23,4,64,21,68,28,71,32,86,30,92,35,94},new int[]{-16,24,-4,25,-8,27,-29,58,-66,59,-67,60,-12,65,-11,66,-10,67,-15,69,-50,70,-52,74,-54,75,-33,77,-55,80,-56,81,-53,91,-51,93});
    states[23] = new State(-20);
    states[24] = new State(-21);
    states[25] = new State(new int[]{30,26});
    states[26] = new State(-23);
    states[27] = new State(-28,new int[]{-3,28});
    ...
    states[31] = new State(new int[]{5,52,4,56},new int[]{-30,32,-14,33,-31,34,-32,35,-34,36,-35,37,-36,38,-37,39,-38,40,-39,41,-40,42,-41,43,-42,44,-43,45,-44,46,-45,47,-46,48,-47,49,-48,50,-49,51,-33,53});
    ...
    states[54] = new State(new int[]{5,52,4,56},new int[]{-14,55,-31,34,-32,35,-34,36,-35,37,-36,38,-37,39,-38,40,-39,41,-40,42,-41,43,-42,44,-43,45,-44,46,-45,47,-46,48,-47,49,-48,50,-49,51,-33,53});
    ...
    states[71] = new State(new int[]{28,71,4,56,32,86,30,92,35,94},new int[]{-15,72,-50,70,-52,74,-54,75,-33,77,-55,80,-56,81,-53,91,-51,93});
    ...
    states[78] = new State(new int[]{5,52,4,56},new int[]{-14,79,-31,34,-32,35,-34,36,-35,37,-36,38,-37,39,-38,40,-39,41,-40,42,-41,43,-42,44,-43,45,-44,46,-45,47,-46,48,-47,49,-48,50,-49,51,-33,53});
    states[79] = new State(-60);
    states[80] = new State(-61);
    states[81] = new State(new int[]{24,82});
    states[82] = new State(new int[]{5,52,4,56},new int[]{-57,83,-14,85,-31,34,-32,35,-34,36,-35,37,-36,38,-37,39,-38,40,-39,41,-40,42,-41,43,-42,44,-43,45,-44,46,-45,47,-46,48,-47,49,-48,50,-49,51,-33,53});
    ...
    states[95] = new State(new int[]{5,52,4,56},new int[]{-14,96,-31,34,-32,35,-34,36,-35,37,-36,38,-37,39,-38,40,-39,41,-40,42,-41,43,-42,44,-43,45,-44,46,-45,47,-46,48,-47,49,-48,50,-49,51,-33,53});
    states[96] = new State(new int[]{25,97});
    states[97] = new State(new int[]{28,71,4,56,32,86,30,92,35,94},new int[]{-15,98,-50,70,-52,74,-54,75,-33,77,-55,80,-56,81,-53,91,-51,93});
    states[98] = new State(new int[]{36,99});
    states[99] = new State(new int[]{28,71,4,56,32,86,30,92,35,94},new int[]{-15,100,-50,70,-52,74,-54,75,-33,77,-55,80,-56,81,-53,91,-51,93});
    ...
    states[107] = new State(new int[]{7,109,8,110,9,111,10,112,11,113,12,114,13,115,14,116,15,117,16,-8},new int[]{-27,108,-28,107});
    ...
    states[125] = new State(-28,new int[]{-3,126});
    states[126] = new State(new int[]{4,57,29,-99},new int[]{-1,29,-2,30});
    states[127] = new State(new int[]{4,105,21,68},new int[]{-8,128,-29,58,-66,59,-67,60,-12,65,-11,66,-10,67});
    states[128] = new State(-28,new int[]{-3,129});
    states[129] = new State(new int[]{4,57,29,-100},new int[]{-1,29,-2,30});
    states[130] = new State(-101);
    states[131] = new State(new int[]{7,133,8,134,9,135,10,136,11,137,12,138,15,139,19,-85},new int[]{-25,132,-63,131});
    ...
    states[140] = new State(new int[]{7,133,8,134,9,135,10,136,11,137,12,138,15,139,3,-76,19,-85},new int[]{-58,141,-23,4,-21,5,-25,6,-63,131});
    ...
    rules[1] = new Rule(-24, new int[]{-22,3});
    rules[2] = new Rule(-23, new int[]{-21});
    rules[3] = new Rule(-21, new int[]{-25,19,4,28,-13,29});
    rules[4] = new Rule(-13, new int[]{-20});
    rules[5] = new Rule(-13, new int[]{-26});
    rules[6] = new Rule(-20, new int[]{-27,-9,4,24,-5,25,-17});
    rules[7] = new Rule(-27, new int[]{-28,-27});
    rules[8] = new Rule(-27, new int[]{});
    rules[9] = new Rule(-9, new int[]{16});
    rules[10] = new Rule(-5, new int[]{-6});
    rules[11] = new Rule(-5, new int[]{});
    rules[12] = new Rule(-6, new int[]{-7});
    rules[13] = new Rule(-7, new int[]{-8,-2});
    rules[14] = new Rule(-8, new int[]{-29});
    rules[15] = new Rule(-8, new int[]{-12});
    rules[16] = new Rule(-12, new int[]{-11});
    rules[17] = new Rule(-11, new int[]{-10});
    rules[18] = new Rule(-10, new int[]{21});
    rules[19] = new Rule(-17, new int[]{-18});
    rules[20] = new Rule(-18, new int[]{28,-19,29});
    rules[21] = new Rule(-19, new int[]{-19,-16});
    rules[22] = new Rule(-19, new int[]{});
    rules[23] = new Rule(-16, new int[]{-4,30});
    rules[24] = new Rule(-16, new int[]{-15});
    rules[25] = new Rule(-2, new int[]{4});
    rules[26] = new Rule(-4, new int[]{-8,-3});
    rules[27] = new Rule(-3, new int[]{-3,-1});
    rules[28] = new Rule(-3, new int[]{});
    rules[29] = new Rule(-1, new int[]{-2});
    rules[30] = new Rule(-1, new int[]{-2,47,-30});
    rules[31] = new Rule(-30, new int[]{-14});
    rules[32] = new Rule(-14, new int[]{-31});
    rules[33] = new Rule(-31, new int[]{-32});
    rules[34] = new Rule(-31, new int[]{-33,38,-14});
    rules[35] = new Rule(-32, new int[]{-34});
    ...
    rules[47] = new Rule(-45, new int[]{-46});
    rules[48] = new Rule(-46, new int[]{-47});
    rules[49] = new Rule(-47, new int[]{-48});
    rules[50] = new Rule(-48, new int[]{-49});
    rules[51] = new Rule(-49, new int[]{5});
    rules[52] = new Rule(-15, new int[]{-50});
    rules[53] = new Rule(-15, new int[]{-51});
    rules[54] = new Rule(-51, new int[]{35,24,-14,25,-15,36,-15});
    rules[55] = new Rule(-50, new int[]{28,-15,29});
    ...
    rules[60] = new Rule(-54, new int[]{-33,38,-14});
    rules[61] = new Rule(-54, new int[]{-55});
    rules[62] = new Rule(-33, new int[]{4});
    rules[63] = new Rule(-55, new int[]{-56,24,-57,25});
    rules[64] = new Rule(-56, new int[]{32,31,33,31,34});
    rules[65] = new Rule(-57, new int[]{-14});
    rules[66] = new Rule(-28, new int[]{7});
    rules[67] = new Rule(-28, new int[]{8});
    rules[68] = new Rule(-28, new int[]{9});
    rules[69] = new Rule(-28, new int[]{10});
    rules[70] = new Rule(-28, new int[]{11});
    rules[71] = new Rule(-28, new int[]{12});
    rules[72] = new Rule(-28, new int[]{13});
    rules[73] = new Rule(-28, new int[]{14});
    rules[74] = new Rule(-28, new int[]{15});
    rules[75] = new Rule(-22, new int[]{-58});
    rules[76] = new Rule(-22, new int[]{-59});
    rules[77] = new Rule(-22, new int[]{-59,-58});
    ...
    rules[83] = new Rule(-58, new int[]{-23});
    rules[84] = new Rule(-25, new int[]{-63,-25});
    rules[85] = new Rule(-25, new int[]{});
    ...
    rules[99] = new Rule(-26, new int[]{-8,-3});
    rules[100] = new Rule(-26, new int[]{-65,-8,-3});
    rules[101] = new Rule(-65, new int[]{-64});
    rules[102] = new Rule(-29, new int[]{-66});
...
#line 125 "javaCompilerParser.y"
                                                                      {CurrentSemanticValue.stmt = ValueStack[ValueStack.Depth-2].varDeclaratorExpr;}
#line default
        break;
...
#line 136 "javaCompilerParser.y"
                                                                   {CurrentSemanticValue.varDeclarator=new AST.VariableDeclarator(ValueStack[ValueStack.Depth-3].varDeclaratorId,ValueStack[ValueStack.Depth-1]);}
#line default
        break;
...
#line default
        break;
      case 34: // AssignmentExpression -> ExpressionName, OP_ASSIGN, Expression
